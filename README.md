...
- Salva tudo no **localStorage**, evitando perda de dados  
- Possui pequenas validações e organização básica de componentes  
...
- uso de `uuid` para criação de IDs únicas  
